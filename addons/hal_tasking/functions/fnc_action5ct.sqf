...
} forEach (((_HQ getVariable [QEGVAR(core,nCrewInfG),[]]) - (_HQ getVariable [QEGVAR(hal_hac,specForG),[]])) + ((_HQ getVariable [QEGVAR(hal_boss,carsG),[]]) - ((_HQ getVariable [QGVAR(aTInfG),[]]) + (_HQ getVariable [QGVAR(aAInfG),[]]) + (_HQ getVariable [QEGVAR(core,supportG),[]]) + (_HQ getVariable [QEGVAR(core,nCCargoG),[]]))));
...
_HQ setVariable [QEGVAR(hal_hac,attackAv),(_HQ getVariable [QEGVAR(hal_hac,attackAv),[]]) - [_chosen]];
