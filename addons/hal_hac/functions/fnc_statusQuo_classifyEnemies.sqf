...
private _specFor_class = RYD_WS_specFor_class;
private _recon_class = RYD_WS_recon_class;
private _FO_class = RYD_WS_FO_class;
private _snipers_class = RYD_WS_snipers_class;
private _ATinf_class = RYD_WS_ATinf_class;
private _AAinf_class = RYD_WS_AAinf_class;
private _Inf_class = RYD_WS_Inf_class;
private _Art_class = RYD_WS_Art_class;
private _HArmor_class = RYD_WS_HArmor_class;
private _MArmor_class = RYD_WS_MArmor_class;
private _LArmor_class = RYD_WS_LArmor_class;
private _LArmorAT_class = RYD_WS_LArmorAT_class;
private _Cars_class = RYD_WS_Cars_class;
private _Air_class = RYD_WS_Air_class;
private _BAir_class = RYD_WS_BAir_class;
private _RAir_class = RYD_WS_RAir_class;
private _NCAir_class = RYD_WS_NCAir_class;
private _Naval_class = RYD_WS_Naval_class;
private _Static_class = RYD_WS_Static_class;
private _StaticAA_class = RYD_WS_StaticAA_class;
private _StaticAT_class = RYD_WS_StaticAT_class;
private _Cargo_class = RYD_WS_Cargo_class;
private _NCCargo_class = RYD_WS_NCCargo_class;
private _Crew_class = RYD_WS_Crew_class;
private _NCrewInf_class = RYD_WS_NCrewInf_class;
private _Support_class = RYD_WS_Support_class;
