...
private _specFor_class = EGVAR(hal_data,wS_specFor_class);
private _recon_class = EGVAR(hal_data,wS_recon_class);
private _FO_class = EGVAR(hal_data,wS_FO_class);
private _snipers_class = EGVAR(hal_data,wS_snipers_class);
private _ATinf_class = EGVAR(hal_data,wS_ATinf_class);
private _AAinf_class = EGVAR(hal_data,wS_AAinf_class);
private _Inf_class = EGVAR(hal_data,wS_Inf_class);
private _Art_class = EGVAR(hal_data,wS_Art_class);
private _HArmor_class = EGVAR(hal_data,wS_HArmor_class);
private _MArmor_class = EGVAR(hal_data,wS_MArmor_class);
private _LArmor_class = EGVAR(hal_data,wS_LArmor_class);
private _LArmorAT_class = EGVAR(hal_data,wS_LArmorAT_class);
private _Cars_class = EGVAR(hal_data,wS_Cars_class);
private _Air_class = EGVAR(hal_data,wS_Air_class);
private _BAir_class = EGVAR(hal_data,wS_BAir_class);
private _RAir_class = EGVAR(hal_data,wS_RAir_class);
private _NCAir_class = EGVAR(hal_data,wS_NCAir_class);
private _Naval_class = EGVAR(hal_data,wS_Naval_class);
private _Static_class = EGVAR(hal_data,wS_Static_class);
private _StaticAA_class = EGVAR(hal_data,wS_StaticAA_class);
private _StaticAT_class = EGVAR(hal_data,wS_StaticAT_class);
private _Cargo_class = EGVAR(hal_data,wS_Cargo_class);
private _NCCargo_class = EGVAR(hal_data,wS_NCCargo_class);
private _Crew_class = EGVAR(hal_data,wS_Crew_class);
private _NCrewInf_class = GVAR(wS_NCrewInf_class);
private _Support_class = EGVAR(hal_data,wS_Support_class);
...
_HQ setVariable [QEGVAR(hal_boss,eValue),_EValue];
...
_HQ setVariable [QEGVAR(hal_boss,enHArmorG),_EnHArmorG];
_HQ setVariable [QGVAR(enMArmorG),_EnMArmorG];
_HQ setVariable [QEGVAR(hal_boss,enLArmorG),_EnLArmorG];
_HQ setVariable [QGVAR(enLArmorATG),_EnLArmorATG];
_HQ setVariable [QEGVAR(hal_boss,enCarsG),_EnCarsG];
_HQ setVariable [QEGVAR(hal_boss,enAirG),_EnAirG];
_HQ setVariable [QGVAR(enBAirG),_EnBAirG];
_HQ setVariable [QGVAR(enRAirG),_EnRAirG];
_HQ setVariable [QEGVAR(hal_boss,enNCAirG),_EnNCAirG];
...
_HQ setVariable [QEGVAR(hal_boss,enSupportG),_EnSupportG];
_HQ setVariable [QGVAR(enCargoG),_EnCargoG];
_HQ setVariable [QEGVAR(hal_boss,enNCCargoG),_EnNCCargoG];
...
_HQ setVariable [QEGVAR(hal_boss,enInfG),_EnInfG];
