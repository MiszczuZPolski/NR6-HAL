...
_FPool = 
	...
	(_HQ getVariable [QEGVAR(core,airG),[]]) - ((_HQ getVariable [QEGVAR(hal_boss,nCAirG),[]]) + (_HQ getVariable [QEGVAR(core,nCrewInfG),[]]) + (_HQ getVariable [QEGVAR(core,ammoDrop),[]])),
	(_HQ getVariable [QEGVAR(hal_boss,lArmorG),[]]),
	(_HQ getVariable [QEGVAR(hal_boss,hArmorG),[]]),
	(_HQ getVariable [QEGVAR(hal_boss,carsG),[]]) - ((_HQ getVariable [QEGVAR(hal_tasking,aTInfG),[]]) + (_HQ getVariable [QEGVAR(hal_tasking,aAInfG),[]]) + (_HQ getVariable [QEGVAR(core,supportG),[]]) + (_HQ getVariable [QEGVAR(core,nCCargoG),[]])),
	(_HQ getVariable [QGVAR(lArmorATG),[]]),
	(_HQ getVariable [QEGVAR(hal_tasking,aTInfG),[]]),
	(_HQ getVariable [QEGVAR(hal_tasking,aAInfG),[]]),
