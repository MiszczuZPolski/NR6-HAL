...
RydHQ_Actions = (_logic getVariable "RydHQ_Actions");
RydHQ_ActionsMenu = (_logic getVariable "RydHQ_Actions");
RydHQ_TaskActions = (_logic getVariable "RydHQ_TaskActions");
RydHQ_SupportActions = (_logic getVariable "RydHQ_SupportActions");
RydHQ_ActionsAceOnly = (_logic getVariable "RydHQ_ActionsAceOnly");
...
RydHQ_SlingDrop = (_logic getVariable "RydHQ_SlingDrop");
RydHQ_RHQAutoFill = (_logic getVariable "RydHQ_RHQAutoFill");

RydHQ_PathFinding = (_logic getVariable "RydHQ_PathFinding");
