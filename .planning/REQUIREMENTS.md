...
- [x] **COMPAT-04**: Legacy `nr6_hal/` directory removed after all functions migrated and verified (in progress — Plan 05-01 extracted VarInit/TimeM/TaskMenu/Sound/CfgRadio; remaining extraction waves in 05-02..05-08)
